...
\address{
{\textbf{Date of birth:}} 03/03/1997 | Age 27 \\
...
{\textbf{E-mail:}} \href{mailto:brunella.d'anzi@cern.ch}{brunella.d'anzi@cern.ch}\\
{\textbf{Website:}} \href{https://www.ba.infn.it/bdanzi/}{https://www.ba.infn.it/bdanzi/}\\
...
\textbf{Career goals:} I am a postdoc researcher at CERN and University of California San Diego (UCSD) after being a Ph.D. student at University and INFN of Bari in Experimental Particle Physics since October 2021. I have been a Doctoral Student at CERN in 2023 as well. My major research interest concerns the double Higgs boson searches with the CMS experiment, coming from my Master's thesis studies. I mostly work with data analysis and data science tools, together with computer programming algorithms, in order to extract physics results from data, such as constraints on the Higgs boson self-couplings. I am also interested in improving and monitoring the current tracking reconstruction algorithms performance in the CMS experiment, as my many contributions during the last years prove. I am also fascinated by gaseous detector technologies development, as it demostrates my Micropattern Gaseous Detector prototype studies during the 3-months INFN internship at CERN, and especially beam tests data-taking as my talks about beam test results show. The high academic standards of my education and professional work inspired me to apply for the Italian 111 Nova List which can be a fertile ground for collaborative and forward-thinking ideas.\\
...
Search for non-resonant production of double Higgs bosons decaying into muon pairs and two b-jets in pp collisions with the CMS experiment at the LHC and future Higgs boson factories\\
...
\textbf{Postdoc at CERN and University of California San Diego (\textit{October 2024--Present}).}\\
After PhD studies in Italy, I have been continuing di-Higgs and tracking studies at CMS for the above mentioned institutes.

\textbf{Official CERN Guide (\textit{April 2023--Present}).}\\
I am a volunteer as a CERN Guide for Visitor Tours in many CERN areas such as the CERN Science Gateway Labs, Exhibitions, Science Shows and CMS Experiment Cavern.
...
\textbf{Chair of sessions in the \textit{Large Hadron Collider (LHC) Job Matching Event Spring '23 and Fall '23}. (\textit{3 May 2023--24 October 2023}).}\\ 
The \href{https://indico.cern.ch/event/1269746/}{Sprint} and \href{https://indico.cern.ch/event/1322376/overview}{Fall}  JMEvs are organized by a team of volunteers, members of the LHC Early Career Scientists Fora, which comprises the ALICE Junior Representatives, ATLAS Early Career Scientist Board, CMS Young Scientists Committee and the LHCb Early Career, Gender and Diversity Office. 
...
\href{https://www.credly.com/badges/74d31153-1544-42c7-a780-079d9bd0a132/linked_in?t=shfsjd}{Selection as one of the McKinsey Forward Program participants} \textbf{(\textit{July 2024})}\\
\href{https://drive.google.com/file/d/1o2VyQushUa8iZLghrVlFZu0CtU27mshC/view?usp=sharing}{Selection as one of the McKinsey Next Generation Women Leaders EMEA participants} \textbf{(\textit{April 2024})}\\
\href{https://indico.cern.ch/event/1246473/}{Selection as one of the participants to the 14th CMS Patatrack Hackathon at CERN} \textbf{(\textit{October 2023})}\\
\href{https://www.linkedin.com/feed/update/urn:li:activity:7121188105495171073/}{Best CMS Technical Shifters 2023} \textbf{(\textit{September 2023})}\\
\href{https://www.linkedin.com/advice/1/how-do-you-avoid-bias-machine-learning-imbalanced}{Invitation to contribute to collaborative articles for LinkedIn Machine Learning, Statistics and Research} \textbf{(\textit{August 2023--Present})}\\
\href{https://indico.cern.ch/event/1246472/}{Selection as one of the participants to the 13th CMS Patatrack Hackathon at CERN} \textbf{(\textit{July 2023})}\\
...
\href{https://www.facebook.com/photo/?fbid=7238817049465803&set=pcb.6561954733818708}{Invitation to be on 100th Suonare News Magazine as representative of Music Conservatory Niccolò Piccinni} \textbf{(\textit{February 2023})}\\
...
As an active member of a large Collaboration like the CMS one, I am a CMS Author of every physics paper since 8th November 2022. I am an author of the FCC and CEPC experiments design reports since 2023. Selected publications, notes, and conference proceedings to which I gave a substantial contribution are listed below.
...
\textbf{CMS Italia Workshop 2024, Plenary Talk}\textbf{(\textit{October 2024})}\\ 
\href{https://indico.cern.ch/event/1387386/contributions/6073743/}{Detector Performance Groups and Physics Objects Groups Report for Run 3 in CMS experiment}

\textbf{42nd International Conference on High Energy Physics 2024 (ICHEP2024), Poster}\textbf{(\textit{July 2024})}\\ 
\href{https://indico.cern.ch/event/1291157/contributions/5876942/}{Tag-and-probe technique tracking efficiency results at CMS}

\textbf{June CMS Week 2024, Plenary Talk}\textbf{(\textit{June 2024})}\\ 
\href{https://indico.cern.ch/event/1418024/contributions/5977492/}{Tracking Performance during Run 3 at the CMS Experiment.}

\textbf{Higgs 2023 Conference, Beijing, China, Talk in HEP Parallel session} \textbf{(\textit{November 2023})}\\ 
\href{https://higgs2023.ihep.ac.cn}{Non resonant double Higgs searches at the CMS Experiment.}

\textbf{109th National Congress of the Società Italiana di Fisica (SIF2023), Talk in HEP Parallel session} \textbf{(\textit{14th September 2022})}\\ 
\href{https://2023.congresso.sif.it/talk/311}{Ricerca di eventi di produzione di coppie di bosoni di Higgs con l'esperimento CMS.}

\textbf{Fourth Edition Machine Learning INFN hackathon - Starting level, Plenary session} \textbf{(\textit{23rd June 2023})}\\
\href{https://agenda.infn.it/event/35607/}{Signal/background discrimination for the VBF Higgs four lepton decay channel with the CMS experiment using Machine Learning classification techniques}
...
\textbf{The 2022 International Workshop on the high energy Circular Electron-Positron Collider (CEPC2022), Talk in Gaseous Detectors Parallel session} \textbf{(\textit{26th October 2022})}\\
...
\textbf{15th Pisa Meeting on Advanced Detectors Edition 2022 (PM2022), Poster} \textbf{(\textit{27th May 2022})}\\ 
...
\textbf{Higgs at CMS Italia Workshop (HIG @CMS Italia), Talk in Plenary Session} \textbf{(\textit{12th May 2022})}\\ 
